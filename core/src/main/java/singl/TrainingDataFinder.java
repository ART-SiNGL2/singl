...
public class TrainingDataFinder extends SiNGLBase{

	protected static String name = "singl.TrainingDataFinder";
	public static final Log LOG = LogFactory.getLog(TrainingDataFinder.class);    

    public TrainingDataFinder() {
        setSiNGLOptions(SiNGLOptions.FIND_TRAINING_DATA);
    }
