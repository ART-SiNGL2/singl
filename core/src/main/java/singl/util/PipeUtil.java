...
import singl.client.pipe.CassandraPipe;
import singl.client.pipe.ElasticPipe;
import singl.client.pipe.FilePipe;
import singl.client.pipe.Format;
...
public class PipeUtil {
	...
	public static Pipe getTrainingDataUnmarkedPipe(Arguments args) {
		...
		p.setProp(FilePipe.LOCATION, args.getSiNGLTrainingDataUnmarkedDir());
		return p;
	}
	...
	public static Pipe getTrainingDataMarkedPipe(Arguments args) {
		Pipe p = new Pipe();
		p.setFormat(Format.PARQUET);
		p.setProp(FilePipe.LOCATION, args.getSiNGLTrainingDataMarkedDir());
		return p;
	}
	...
	public static Pipe getModelDocumentationPipe(Arguments args) {
		...
		p.setProp(FilePipe.LOCATION, args.getSiNGLDocFile());
		return p;
	}
