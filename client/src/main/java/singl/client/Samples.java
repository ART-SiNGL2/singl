 ...
 * and the field definitions as suggested by SiNGL FieldDefinitions suggested
 * by SiNGL are an approximation, clients are free to define their own
 * definitions
 * 
 * @author sgoyal
 *
...
public class Samples implements Serializable {
	...
	/**
	 * Get the field definitions approximated by SiNGL
	 * 
